...
updates, and software-blackout gate. `MainActivity` is intentionally a small
recording/telemetry UI. The next acceptance test is one real phone recording replayed
through `python -m tools.phone_replay.run`.
